...
from reformulation_functions_updated import get_external_information, external_ref
# Import models
...
external_ref(m, [1, 2, 1], problem_logic_batch, dict_extvar)
...
external_ref(m, [1, 1], problem_logic_cstr, dict_extvar)
...
# 5: Now we can apply the external variables reformulation
external_ref(m, [13, 2], problem_logic_column, dict_extvar)
